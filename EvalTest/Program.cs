...
var mockDeviceReadings = new Dictionary<Guid, LastReadings>
{
    ...
    { Guid.Parse("44C22283-0F08-4B00-948B-1A089E75C114"), new LastReadings { { "temperature", 29.0 },  { "unusedDataPoint1", 1 }, { "unusedDataPoint2", 2 } } },
...
var signaled = AutomationTriggerBase.GetSignaledTriggers(automation);
Console.WriteLine($"signaled automations:\n{string.Join("\n", signaled)}");
